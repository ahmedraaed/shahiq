...
class ReminderEmptyStateScreen extends StatelessWidget {
  const ReminderEmptyStateScreen({Key? key}) : super(key: key);
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                centerTitle: true,
                title: AppbarTitle(text: "تنبيه وقت التأمل")),
            body: Container(
                width: double.maxFinite,
                padding: getPadding(left: 20, top: 181, right: 20, bottom: 181),
                child: Row(
                    ...
                    children: [
                      Container(
                          ...
                          child: Stack(alignment: Alignment.topLeft, children: [
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                          ...
                                          child: Text(
                                              "تنبيهات وقت التأمل فارغة",
                                              maxLines: null,
                                              textAlign: TextAlign.center,
                                              style:
                                                  AppStyle.txtJannaLTBold20)),
                                      Container(
                                          width: getHorizontalSize(187),
                                          margin: getMargin(top: 1),
                                          child: Text(
                                              "يمكنك اضافة تنبيه لوقت التأمل من هنا",
                                              maxLines: null,
                                              textAlign: TextAlign.center,
                                              style: AppStyle
                            ...
                            CustomImageView(
                                svgPath:
                                    ImageConstant.imgIllstrremindersemptyarrow,
                                height: getSize(166),
                                width: getSize(166),
                      ...
                      CustomIconButton(
                          height: 56,
                          width: 56,
                          margin: getMargin(left: 24, top: 376, bottom: 5),
